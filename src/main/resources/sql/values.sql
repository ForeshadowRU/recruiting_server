INSERT INTO `recruiting-server`.companies (vacancyId, name, contact_email, registration_date, foundation_date) VALUES
...
INSERT INTO `recruiting-server`.vacancies (vacancyId, name, description, author_id, hidden, creation_date)
